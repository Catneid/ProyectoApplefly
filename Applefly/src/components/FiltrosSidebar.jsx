import { categorias, conditions } from '../data/phones.js';
import Boton from './Boton.jsx';
import './FiltrosSidebar.css';

/**
 * Barra lateral de filtros para el catálogo.
 * Props: filtros, setFiltros, precioMax
 */
const FiltrosSidebar = ({ filtros, setFiltros, precioMax = 2500, onCerrar }) => {
