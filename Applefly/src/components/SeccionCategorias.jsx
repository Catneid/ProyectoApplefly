...
const categorias = [
  {
    nombre: 'iPhone',
    descripcion: 'iPhone 11, 12, 13, 14 y 15 Pro',
    icono: (
  ...
  {
    nombre: 'iPad',
    descripcion: 'iPad Air, iPad Pro y iPad mini',
    icono: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    nombre: 'MacBook',
    descripcion: 'MacBook Air y MacBook Pro',
    icono: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    nombre: 'Apple Watch',
    descripcion: 'Series 8, 9, Ultra y SE',
    icono: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  {
    nombre: 'AirPods',
    descripcion: 'AirPods Pro, Max y AirPods 4',
    icono: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="container">
        ...
        <div className="categorias__grid">
          {categorias.map((cat) => (
            ...
            >
              <div className="categorias__icono">{cat.icono}</div>
